...
export default function Header() {
  ...
  const { pro, isLoading: billingLoading, startCheckout } = useBilling();
  ...
  const handleUpgrade = async () => {
    ...
    try {
      ...
      toast({ variant: "destructive", title: "Checkout unavailable", description: "Please try again in a moment." });
    }
  };
            ...
            {user ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  <DropdownMenuSeparator />
                  {!billingLoading && !pro && (
                    <DropdownMenuItem onClick={handleUpgrade}><Crown className="mr-2 h-4 w-4 text-primary" />Upgrade to Pro — $100/mo</DropdownMenuItem>
                  )}
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-44">
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onClick={handleUpgrade}><Crown className="mr-2 h-4 w-4 text-primary" />Get Pro — $100/mo</DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            )}
